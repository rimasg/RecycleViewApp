...
import com.sid.recycleviewapp.databinding.FragmentItemListBinding;
...
public class ItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Set the adapter
        binding.list.setAdapter(new ItemRecyclerViewAdapter(EmptyContent.ITEMS, mListener, binding.list));
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(DummyItem item, ItemRecyclerViewAdapter.ViewHolder mContentView);
    }
}
